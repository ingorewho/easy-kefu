"""Kimi Session Manager - Manages conversation history for Kimi bot"""
import sqlite3
import json
import time
import os
...
class KimiSessionManager:
    ...
    def __init__(self, db_path: str = "database/kimi_sessions.db"):
        self.logger = get_logger("KimiSessionManager")
        # 确保目录存在
